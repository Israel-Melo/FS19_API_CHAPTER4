...
namespace Chapter.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        private SigningCredentials credenciais;
        ...
        public IActionResult Login(LoginViewModel login)
        {
            ...
            {
                return Unauthorized(new {msg = "Email ou Senha invalidos"});
            }
            ...
            var chave = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("chapter-chave-autcacao"));
        
            var credenciais = new SigningCredentials(chave, SecurityAlgorithms.HmacSha256);

            var meuToken = new JwtSecurityToken(
                issuer: "chapter.webapi",
                audience: "Chater.webapi",
